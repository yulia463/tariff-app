...
export default function Page() {
    ...
    return (
      ...
      pt-[20px] px-[16px]          /* мобильные отступы */
      text-[22px]                  /* 320 */
      min-[375px]:text-[24px]      /* 375 */
      min-[440px]:text-[40px] min-[440px]:pt-[50px]
      min-[440px]:justify-center   /* десктоп центр */
    "
                >
                    <div className="m-0">
                        <span className="whitespace-nowrap block min-[440px]:inline">
        Выбери подходящий
      </span>{" "}
                        <span className="block min-[440px]:inline">
        для себя <span className="text-[var(--color-yellow)]">тариф</span>
      </span>
                    </div>
                </div>
