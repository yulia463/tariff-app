...
export default function Page() {
    ...
    return (
        <div className="min-h-screen bg-[#0f1720] text-white">
            ...
            <main className="max-w-6xl mx-auto px-4 pt-[120px] pb-8  rounded-b-[60px]">
                <h1 className="text-3xl font-semibold mb-6">Выбери тариф</h1>
                ...
                <div className="mt-8 flex items-center gap-4">
                    <label className={`flex items-center gap-2 ${buyError ? 'text-red-400' : ''}`}>
                        <input
                            ...
                            onChange={(e) => { setAgreeChecked(e.target.checked); setBuyError(null) }}
